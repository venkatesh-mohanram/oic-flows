...
resource "oic_oicconnection" "restinvoke" {
  ...
  depends_on = [oic_oicproject.tf_rollback_usecase_deploymentv1, oic_oicproject.tf_rollback_usecase_deploymentv2]
...
resource "oic_oicconnection" "weatherconnection" {
  ...
  depends_on = [oic_oicproject.tf_rollback_usecase_deploymentv2]
